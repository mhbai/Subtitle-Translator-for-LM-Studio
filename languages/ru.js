...
const ru = {
    ...
    batchModeInfo: "Когда эта функция включена, программа обрабатывает 30 строк текста одновременно особым образом, что позволяет выполнять перевод быстрее с лучшим пониманием и точностью"
};
