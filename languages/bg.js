...
const bg = {
    ...
    batchModeInfo: "Когато тази функция е активирана, програмата обработва 30 реда текст наведнъж по специален начин, позволяващ по-бърз превод с по-добро разбиране и точност"
};
