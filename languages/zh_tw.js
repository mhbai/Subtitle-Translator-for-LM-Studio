// 繁體中文（台灣） language file
const zh_tw = {
    // Main title
    appTitle: "SRT字幕翻譯器",
    // File upload
    fileUploadTitle: "上傳字幕檔案",
    fileInputLabel: "選擇檔案",
    browseButton: "瀏覽...",
    ...
    errorInvalidFile: "僅能載入 .srt、.wrk 或 .mmm 檔！",
    ...
    errorServerConnection: "無法連接至 LM Studio 伺服器",
    ...
    batchModeInfo: "啟用此功能後，程式會以特殊方式一次處理 30 行文本，從而實現更快、更準確的翻譯"
};
